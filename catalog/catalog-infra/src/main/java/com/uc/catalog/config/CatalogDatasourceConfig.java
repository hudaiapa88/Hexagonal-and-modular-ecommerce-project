...
@EnableJpaRepositories(
        ...
        basePackages = { "com.uc.catalog.adapters.product", "com.uc.catalog.adapters.category" })
@EntityScan(basePackages ={ "com.uc.catalog.adapters.product", "com.uc.catalog.adapters.category" })
public class CatalogDatasourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean
        ...
        return builder.dataSource(dataSource)
                .packages("com.uc.catalog.adapters.category","com.uc.catalog.adapters.product")
